//! Cross-process producer / consumer API surface for `disruptor-mp`.
//!
//! This private module holds the public types re-exported from the
//! crate root: producers, consumers, shared-memory helpers, mmap
//! helpers, and coordination primitives.
//!
//! The important split is:
//!
//! - builder entry points create or attach the underlying transport
//! - producers publish into the ring
//! - consumers poll or process available events
//! - cursors and barriers provide the shared coordination state
//!
//! Prefer the crate-root docs and README for the high-level transport
//! model. This module exists to document the concrete API surface.
