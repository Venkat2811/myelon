...
use crate::report_v2::{BenchReportCompat, ReportBundle};
use crate::reporting::{BenchConfig, BenchReport, BenchResult};
...
mod tests {
    ...
    use crate::reporting::{BenchMetadata, BenchResults};
    ...
    #[test]
    fn parse_bench_report_accepts_report_v2_json() {
        let mut report = BenchReport::new();
        ...
        let json = report.to_report_v2().to_json_pretty();
