...
const CHILD_ROLES: &[harness::ChildRole] = &[
    harness::ChildRole::new("competitive_codec_shm_echo", producer_process),
    harness::ChildRole::new("competitive_codec_shm_initiator", consumer_process),
];

pub struct CompetitiveCodecShmBench;

impl harness::BenchHarness for CompetitiveCodecShmBench {
