...
use crate::executor_v2::myelon::codec::zero_copy_support::{
...
impl IpcBenchmark for Scenario {
    fn bench_name(&self) -> &str {
        "competitive_typed_zero_copy_mmap"
    }
...
const CHILD_ROLES: &[harness::ChildRole] = &[
    harness::ChildRole::new("competitive_typed_zero_copy_mmap_echo", producer_process),
...
pub struct CompetitiveTypedZeroCopyMmapBench;

impl harness::BenchHarness for CompetitiveTypedZeroCopyMmapBench {
