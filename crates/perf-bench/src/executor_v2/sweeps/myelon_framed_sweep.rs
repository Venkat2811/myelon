...
use crate::codec_payloads::access_raw;
use crate::coordination::BenchmarkCoordination;
use crate::events::{format_throughput, nanos_now};
use crate::harness::{
...
use crate::reporting::{self, BenchReport, ReportOutputArgs, ReportView};
...
const CHILD_ROLES: &[harness::ChildRole] = &[
    harness::ChildRole::new("shm_frame64_prod", shm_frame64_prod),
    harness::ChildRole::new("shm_frame64_cons", shm_frame64_cons),
    harness::ChildRole::new("shm_frame2k_prod", shm_frame2k_prod),
    harness::ChildRole::new("shm_frame2k_cons", shm_frame2k_cons),
    harness::ChildRole::new("shm_frame8k_prod", shm_frame8k_prod),
    harness::ChildRole::new("shm_frame8k_cons", shm_frame8k_cons),
    harness::ChildRole::new("shm_frame32k_prod", shm_frame32k_prod),
    harness::ChildRole::new("shm_frame32k_cons", shm_frame32k_cons),
    harness::ChildRole::new("shm_frame128k_prod", shm_frame128k_prod),
    harness::ChildRole::new("shm_frame128k_cons", shm_frame128k_cons),
    harness::ChildRole::new("mmap_frame64_prod", mmap_frame64_prod),
    harness::ChildRole::new("mmap_frame64_cons", mmap_frame64_cons),
    harness::ChildRole::new("mmap_frame2k_prod", mmap_frame2k_prod),
    harness::ChildRole::new("mmap_frame2k_cons", mmap_frame2k_cons),
    harness::ChildRole::new("mmap_frame8k_prod", mmap_frame8k_prod),
    harness::ChildRole::new("mmap_frame8k_cons", mmap_frame8k_cons),
    harness::ChildRole::new("mmap_frame32k_prod", mmap_frame32k_prod),
    harness::ChildRole::new("mmap_frame32k_cons", mmap_frame32k_cons),
    harness::ChildRole::new("mmap_frame128k_prod", mmap_frame128k_prod),
    harness::ChildRole::new("mmap_frame128k_cons", mmap_frame128k_cons),
];

pub struct MyelonFramedSweep;

impl harness::BenchHarness for MyelonFramedSweep {
