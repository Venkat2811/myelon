...
const CHILD_ROLES: &[infra::ChildRole] = &[
    infra::ChildRole::new("pingpong_codec_mmap_echo", producer_process),
    infra::ChildRole::new("pingpong_codec_mmap_initiator", consumer_process),
];

pub struct PingPongCodecMmapBench;

impl infra::BenchHarness for PingPongCodecMmapBench {
