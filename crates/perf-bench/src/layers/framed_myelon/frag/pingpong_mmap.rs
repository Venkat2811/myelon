...
const CHILD_ROLES: &[infra::ChildRole] = &[
    infra::ChildRole::new("pingpong_framed_mmap_echo", producer_process),
    infra::ChildRole::new("pingpong_framed_mmap_initiator", consumer_process),
];

pub struct PingPongFramedMmapBench;

impl infra::BenchHarness for PingPongFramedMmapBench {
