...
fn framed_batch_consumer() -> Result<(), Box<dyn std::error::Error>> {
    ...
    while consumed < events {
        ...
        if consumed < events {
            infra::check_deadline(deadline, "framed_batch_consumer measured");
            std::hint::spin_loop();
        }
    }
...
fn ml_framed_batch_mmap_consumer() -> Result<(), Box<dyn std::error::Error>> {
    ...
    while consumed < events {
        ...
        if consumed < events {
            infra::check_deadline(deadline, "ml_framed_batch_mmap_consumer measured");
            std::hint::spin_loop();
        }
    }
    let elapsed = start.expect("consumer never received a batch").elapsed();
...
rightsized_framed_mmap_impl!(
    Frame2K,
    ml_rs_framed_mmap_prod_2k,
    ml_rs_framed_mmap_cons_2k
);
rightsized_framed_mmap_impl!(
    Frame8K,
    ml_rs_framed_mmap_prod_8k,
    ml_rs_framed_mmap_cons_8k
);
rightsized_framed_mmap_impl!(
    Frame32K,
    ml_rs_framed_mmap_prod_32k,
    ml_rs_framed_mmap_cons_32k
);
...
rkyv_nofrag_mmap_impl!(
    RkyvSlot2K,
    2040,
    ml_rkyv_nf_mmap_prod_2k,
    ml_rkyv_nf_mmap_cons_2k
);
rkyv_nofrag_mmap_impl!(
    RkyvSlot8K,
    8184,
    ml_rkyv_nf_mmap_prod_8k,
    ml_rkyv_nf_mmap_cons_8k
);
rkyv_nofrag_mmap_impl!(
    RkyvSlot32K,
    32760,
    ml_rkyv_nf_mmap_prod_32k,
    ml_rkyv_nf_mmap_cons_32k
);
rkyv_nofrag_mmap_impl!(
    RkyvSlot128K,
    131064,
    ml_rkyv_nf_mmap_prod_128k,
    ml_rkyv_nf_mmap_cons_128k
);
...
const CHILD_ROLES: &[infra::ChildRole] = &[
    // SHM: raw ring
    infra::ChildRole::new("raw_prod_1k", raw_prod_1k),
    infra::ChildRole::new("raw_cons_1k", raw_cons_1k),
    infra::ChildRole::new("raw_prod_4k", raw_prod_4k),
    infra::ChildRole::new("raw_cons_4k", raw_cons_4k),
    infra::ChildRole::new("raw_prod_16k", raw_prod_16k),
    infra::ChildRole::new("raw_cons_16k", raw_cons_16k),
    infra::ChildRole::new("raw_prod_64k", raw_prod_64k),
    infra::ChildRole::new("raw_cons_64k", raw_cons_64k),
    // SHM: raw myelon
    infra::ChildRole::new("my_raw_prod_1k", my_raw_prod_1k),
    infra::ChildRole::new("my_raw_cons_1k", my_raw_cons_1k),
    infra::ChildRole::new("my_raw_prod_4k", my_raw_prod_4k),
    infra::ChildRole::new("my_raw_cons_4k", my_raw_cons_4k),
    infra::ChildRole::new("my_raw_prod_16k", my_raw_prod_16k),
    infra::ChildRole::new("my_raw_cons_16k", my_raw_cons_16k),
    infra::ChildRole::new("my_raw_prod_64k", my_raw_prod_64k),
    infra::ChildRole::new("my_raw_cons_64k", my_raw_cons_64k),
    // SHM: framed
    infra::ChildRole::new("framed_prod", framed_producer),
    infra::ChildRole::new("framed_cons", framed_consumer),
    infra::ChildRole::new("framed_batch_cons", framed_batch_consumer),
    // SHM: typed zero-copy
    infra::ChildRole::new("typed_zc_prod", typed_zc_producer),
    infra::ChildRole::new("typed_zc_cons", typed_zc_consumer),
    // SHM: right-sized framed
    infra::ChildRole::new("rs_framed_prod_2k", rs_framed_prod_2k),
    infra::ChildRole::new("rs_framed_cons_2k", rs_framed_cons_2k),
    infra::ChildRole::new("rs_framed_prod_8k", rs_framed_prod_8k),
    infra::ChildRole::new("rs_framed_cons_8k", rs_framed_cons_8k),
    infra::ChildRole::new("rs_framed_prod_32k", rs_framed_prod_32k),
    infra::ChildRole::new("rs_framed_cons_32k", rs_framed_cons_32k),
    // SHM: rkyv nofrag
    infra::ChildRole::new("rkyv_nf_prod_2k", rkyv_nf_prod_2k),
    infra::ChildRole::new("rkyv_nf_cons_2k", rkyv_nf_cons_2k),
    infra::ChildRole::new("rkyv_nf_prod_8k", rkyv_nf_prod_8k),
    infra::ChildRole::new("rkyv_nf_cons_8k", rkyv_nf_cons_8k),
    infra::ChildRole::new("rkyv_nf_prod_32k", rkyv_nf_prod_32k),
    infra::ChildRole::new("rkyv_nf_cons_32k", rkyv_nf_cons_32k),
    infra::ChildRole::new("rkyv_nf_prod_128k", rkyv_nf_prod_128k),
    infra::ChildRole::new("rkyv_nf_cons_128k", rkyv_nf_cons_128k),
    // MMAP: raw ring
    infra::ChildRole::new("ml_raw_mmap_prod_1k", ml_raw_mmap_prod_1k),
    infra::ChildRole::new("ml_raw_mmap_cons_1k", ml_raw_mmap_cons_1k),
    infra::ChildRole::new("ml_raw_mmap_prod_4k", ml_raw_mmap_prod_4k),
    infra::ChildRole::new("ml_raw_mmap_cons_4k", ml_raw_mmap_cons_4k),
    infra::ChildRole::new("ml_raw_mmap_prod_16k", ml_raw_mmap_prod_16k),
    infra::ChildRole::new("ml_raw_mmap_cons_16k", ml_raw_mmap_cons_16k),
    infra::ChildRole::new("ml_raw_mmap_prod_64k", ml_raw_mmap_prod_64k),
    infra::ChildRole::new("ml_raw_mmap_cons_64k", ml_raw_mmap_cons_64k),
    // MMAP: raw myelon
    infra::ChildRole::new("ml_my_raw_mmap_prod_1k", ml_my_raw_mmap_prod_1k),
    infra::ChildRole::new("ml_my_raw_mmap_cons_1k", ml_my_raw_mmap_cons_1k),
    infra::ChildRole::new("ml_my_raw_mmap_prod_4k", ml_my_raw_mmap_prod_4k),
    infra::ChildRole::new("ml_my_raw_mmap_cons_4k", ml_my_raw_mmap_cons_4k),
    infra::ChildRole::new("ml_my_raw_mmap_prod_16k", ml_my_raw_mmap_prod_16k),
    infra::ChildRole::new("ml_my_raw_mmap_cons_16k", ml_my_raw_mmap_cons_16k),
    infra::ChildRole::new("ml_my_raw_mmap_prod_64k", ml_my_raw_mmap_prod_64k),
    infra::ChildRole::new("ml_my_raw_mmap_cons_64k", ml_my_raw_mmap_cons_64k),
    // MMAP: framed
    infra::ChildRole::new("ml_framed_mmap_prod", ml_framed_mmap_producer),
    infra::ChildRole::new("ml_framed_mmap_cons", ml_framed_mmap_consumer),
    infra::ChildRole::new("ml_framed_batch_mmap_cons", ml_framed_batch_mmap_consumer),
    // MMAP: right-sized framed
    infra::ChildRole::new("ml_rs_framed_mmap_prod_2k", ml_rs_framed_mmap_prod_2k),
    infra::ChildRole::new("ml_rs_framed_mmap_cons_2k", ml_rs_framed_mmap_cons_2k),
    infra::ChildRole::new("ml_rs_framed_mmap_prod_8k", ml_rs_framed_mmap_prod_8k),
    infra::ChildRole::new("ml_rs_framed_mmap_cons_8k", ml_rs_framed_mmap_cons_8k),
    infra::ChildRole::new("ml_rs_framed_mmap_prod_32k", ml_rs_framed_mmap_prod_32k),
    infra::ChildRole::new("ml_rs_framed_mmap_cons_32k", ml_rs_framed_mmap_cons_32k),
    // MMAP: typed zero-copy
    infra::ChildRole::new("ml_typed_zc_mmap_prod", ml_typed_zc_mmap_producer),
    infra::ChildRole::new("ml_typed_zc_mmap_cons", ml_typed_zc_mmap_consumer),
    // MMAP: rkyv nofrag
    infra::ChildRole::new("ml_rkyv_nf_mmap_prod_2k", ml_rkyv_nf_mmap_prod_2k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_cons_2k", ml_rkyv_nf_mmap_cons_2k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_prod_8k", ml_rkyv_nf_mmap_prod_8k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_cons_8k", ml_rkyv_nf_mmap_cons_8k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_prod_32k", ml_rkyv_nf_mmap_prod_32k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_cons_32k", ml_rkyv_nf_mmap_cons_32k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_prod_128k", ml_rkyv_nf_mmap_prod_128k),
    infra::ChildRole::new("ml_rkyv_nf_mmap_cons_128k", ml_rkyv_nf_mmap_cons_128k),
];

pub struct MyelonLayersBench;

impl infra::BenchHarness for MyelonLayersBench {
    ...
    fn run_orchestrator(&self, args: &[String]) -> infra::BenchRunResult {
        let mut bench_log = crate::infra::output::log::BenchLog::default_capacity("myelon_layers");
        ...
        for spec in sweep_specs::payload_sweep_specs() {
            ...
            for consumers in sweep_specs::TARGET_CONSUMERS {
                ...
                for backend in [SweepBackend::Shm, SweepBackend::Mmap] {
                    ...
                    for variant in
                        sweep_specs::myelon_layer_variant_specs_for_backend(spec.tag, backend)
                    {
        ...
        if !selection.output_args.json_mode {
            report.to_report().print_layer_comparison();
        }
